...
flex grow-0 shrink-0 basis-3 w-3 h-[5px] -rounded-tl--input-borderRadius
                       "
            ></div>

            <div v-if="label"
                 class="bi-label
flex grow-1 shrink-0 basis-0 relative top-0 z-0 -text--inputLabel-fontSize
opacity-0 overflow-hidden whitespace-nowrap overflow-ellipsis
...
flex grow-0 shrink-[3] basis-full h-[5px] -rounded-tr--input-borderRadius
                "></div>
        </div>

        <div class="bi-wrap
-p--input-padding border-solid -border--input-borderWidth
border-t-transparent -border-x--input-borderColor
-border-b--input-borderColor -rounded--input-borderRadius
            "
             :class="{
