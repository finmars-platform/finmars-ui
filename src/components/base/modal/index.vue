    ...
    <Teleport to="body" v-if="modelValue">
        <transition name="fade">
            <div
                v-show="modelValue"
                class="
flex justify-center items-center fixed inset-0 -z---modal-zIndex
-text--baseText-color
                "
            ...
            >
                ...
                <div
                    class="modal
relative min-w-80 max-w-[90%] -rounded--modal-borderRadius
                    "
                    v-bind="$attrs"
                >
                    <div class="modal_top
flex items-center justify-between -bg--modalHeader-backgroundColor
-rounded-t--modal-borderRadius
                    ">
                        ...
                        <div class="flex items-center">
                            <div class="
-text--modalTitle-fontSize -font--modalTitle-fontFamily
-font--modalTitle-fontWeight -leading--modalTitle-lineHeight
-tracking---modalTitle-letterSpacing
                            ">
                                {{ title }}
                            </div>
                            <slot name="header" />
                    ...
                    <div
                        v-if="$slots.footer"
                        class="
modal_bottom -bg--modalFooter-backgroundColor -rounded-b--modal-borderRadius
                        "
                    >
