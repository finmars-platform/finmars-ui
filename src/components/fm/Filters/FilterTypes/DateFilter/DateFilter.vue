<template>
	<div class="fm-date-filter">
		<div class="fm-date-filter__row">
			...
			<div class="fm-date-filter__cell">
				...
				<template v-if="rangeMode">
					<FmInputDate
						:model-value="
							(filter?.options?.filter_values as FmFilterRangeValues).min_value as string
						"
					...
					<FmInputDate
						:model-value="
							(filter?.options?.filter_values as FmFilterRangeValues).max_value as string
						"
						placeholder="Date to"
						persistent-placeholder
						compact
		...
		<div v-if="selectorMode" class="fm-date-filter__tree">
			<hr />
