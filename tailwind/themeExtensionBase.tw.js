export default {
	...
	colors: {
		...
		'--iconButton-hover-backgroundColor':
			'var(--iconButton-hover-backgroundColor)',
		'--iconButton-focus-color': 'var(--iconButton-focus-color)',
		'--iconButton-focus-backgroundColor':
			'var(--iconButton-focus-backgroundColor)',
		'--iconButton-active-color': 'var(--iconButton-active-color)',
		'--iconButton-active-backgroundColor':
			'var(--iconButton-active-backgroundColor)',
		'--iconButton-disabled-color': 'var(--iconButton-disabled-color)',
		'--iconButton-disabled-backgroundColor':
			'var(--iconButton-disabled-backgroundColor)',

		'--iconButton-filled-color': 'var(--iconButton-filled-color)',
		'--iconButton-filled-backgroundColor':
			'var(--iconButton-filled-backgroundColor)',
		'--iconButton-filled-hover-color': 'var(--iconButton-filled-hover-color)',
		'--iconButton-filled-hover-backgroundColor':
			'var(--iconButton-filled-hover-backgroundColor)',
		'--iconButton-filled-focus-color': 'var(--iconButton-filled-focus-color)',
		'--iconButton-filled-focus-backgroundColor':
			'var(--iconButton-filled-focus-backgroundColor)',
		'--iconButton-filled-active-color': 'var(--iconButton-filled-active-color)',
		'--iconButton-filled-active-backgroundColor':
			'var(--iconButton-filled-active-backgroundColor)',
		'--iconButton-filled-disabled-color':
			'var(--iconButton-filled-disabled-color)',
		'--iconButton-filled-disabled-backgroundColor':
			'var(--iconButton-filled-disabled-backgroundColor)',
		...
		'--button-text-hover-backgroundColor':
			'var(--button-text-hover-backgroundColor)',

		'--button-text-focus-color': 'var(--button-text-focus-color)',
		'--button-text-focus-backgroundColor':
			'var(--button-text-focus-backgroundColor)',

		'--button-text-active-color': 'var(--button-text-active-color)',
		'--button-text-active-backgroundColor':
			'var(--button-text-active-backgroundColor)',

		'--button-text-disabled-color': 'var(--button-text-disabled-color)',
		'--button-text-disabled-backgroundColor':
			'var(--button-text-disabled-backgroundColor)',
		...
		'--button-filled-hover-backgroundColor':
			'var(--button-filled-hover-backgroundColor)',
		'--button-filled-focus-color': 'var(--button-filled-focus-color)',
		'--button-filled-focus-backgroundColor':
			'var(--button-filled-focus-backgroundColor)',
		'--button-filled-active-color': 'var(--button-filled-active-color)',
		'--button-filled-active-backgroundColor':
			'var(--button-filled-active-backgroundColor)',
		'--button-filled-disabled-color': 'var(--button-filled-disabled-color)',
		'--button-filled-disabled-backgroundColor':
			'var(--button-filled-disabled-backgroundColor)'
	},
	backgroundColor: {
